...
class _ZoomableImageState extends State<ZoomableImage> {
  ...
  Widget build(BuildContext ctx) {
    ...
    Widget paintWidget() {
      return CustomPaint(
        ...
        foregroundPainter: _ZoomableImagePainter(_image, _offset, _scale, lines, _image2),
      );
    }
  ...
  loadImage2() async {
    print('create painting layer img ${_image.width} x ${_image.height}');
    _paintingImage = img.Image(_image.width, _image.height);
    _image2 = await decodeImageFromList(img.encodePng(_paintingImage));
...
class _ZoomableImagePainter extends CustomPainter {
  ...
  _ZoomableImagePainter(this.image, this.offset, this.scale, this.lines, this.image2);
